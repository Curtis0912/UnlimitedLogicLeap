package com.curtis.uul.service.impl;
...
import com.curtis.uul.constant.CommonConstant;
import com.curtis.uul.exception.ThrowUtils;
import com.curtis.uul.mapper.AppMapper;
import com.curtis.uul.model.dto.app.AppQueryRequest;
...
import com.curtis.uul.model.enums.ReviewStatusEnum;
import com.curtis.uul.model.vo.AppVO;
import com.curtis.uul.model.vo.UserVO;
import com.curtis.uul.service.AppService;
import com.curtis.uul.service.UserService;
import com.curtis.uul.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(appScoringStrategyEnum == null, ErrorCode.PARAMS_ERROR,"评分策略错误");

        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名称大于80字符");
        }
        if (StringUtils.isNotBlank(appDesc)) {
            ThrowUtils.throwIf(appName.length() > 300, ErrorCode.PARAMS_ERROR, "应用详情大于300字符");
        }
